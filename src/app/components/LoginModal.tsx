...
export default function LoginModal({ isOpen, onClose, onLogin }: LoginModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-[420px] rounded-lg bg-white shadow-2xl p-8 min-h-[522px]"
      ...
      >
        ...
        {/* Centered Content */}
        <div className="flex flex-col items-center h-full pt-8 space-y-4">
          {/* Header */}
          <h2 className="text-2xl font-bold text-gray-900">Log in to Summarist</h2>

          {/* Body */}
          <div>
            {/* Login as Guest Button - Changed to navy blue */}
            <button
  onClick={handleGuestLogin}
  disabled={isLoading}
  className="w-full relative flex items-center justify-center rounded-md bg-blue-800 py-3 text-base font-medium text-white hover:bg-blue-900 disabled:opacity-60 transition"
>
  <div className="absolute left-4 w-10 h-10 bg-white rounded-sm flex items-center justify-center">
  ...
  <div className="flex-1 border-t border-gray-300"></div>
            ...
            {/* Login with Google Button - Changed to lighter blue with proper Google icon */}
           <button
...
>
  ...
  type="submit"
  disabled={isLoading}
  className="w-full bg-green-500 hover:bg-green-600 text-blue-900 py-3 rounded-md font-medium transition disabled:opacity-60 mt-2"
>
