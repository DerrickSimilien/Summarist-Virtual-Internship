...
const CheckoutPage = () => {
  ...
  // Parse ?plan=... from the URL on the client
  useEffect(() => {
    try {
      const sp = new URLSearchParams(window.location.search);
      const p = (sp.get('plan') || 'yearly').toLowerCase();
  ...
  const [formData, setFormData] = useState({
    email: '', // will be set based on logged-in user
    cardNumber: '',
    expiryDate: '',
    cvc: '',
    cardholderName: '',
    ...
    const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      ...
      if (currentUser) {
        if (currentUser.email === 'guest@gmail.com') {
          setFormData((prev) => ({ ...prev, email: 'guest@guest.com' }));
        } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Processing subscription...', { plan, ...formData });
          ...
          <form onSubmit={handleSubmit}>
              ...
              >
                ...
                >
                  <svg width="24" height="8" viewBox="0 0 24 8" fill="none">
                    <path
                      d="M7.7 1.4L6.3 6.6H4.8L4 2.9C3.9 2.5 3.7 2.3 3.3 2.1C2.8 1.8 2.1 1.5 1.4 1.3L1.5 1.4H4.2C4.6 1.4 4.9 1.7 5 2.1L5.9 6.6H7.4L9.2 1.4H7.7Z"
                      fill="#1434CB"
                    />
                    <path d="M12.1 1.4L10.7 6.6H9.2L10.6 1.4H12.1Z" fill="#1434CB" />
                    <path
                      d="M15.9 2.8C15.9 2.4 16.2 2.2 16.7 2.2C17.3 2.2 18 2.4 18.5 2.7L18.9 1.6C18.4 1.4 17.7 1.2 16.9 1.2C15.4 1.2 14.4 2 14.4 3.1C14.4 3.9 15.1 4.4 15.6 4.7C16.2 5 16.4 5.2 16.4 5.5C16.4 5.9 15.9 6.1 15.4 6.1C14.7 6.1 14 5.9 13.4 5.6L13 6.7C13.7 7 14.5 7.1 15.3 7.1C17 7.1 18 6.3 18 5.1C18 3.7 15.9 3.6 15.9 2.8Z"
                      fill="#1434CB"
                    />
                    <path
                      d="M22.2 6.6H23.6L22.3 1.4H21C20.7 1.4 20.4 1.6 20.3 1.9L18.1 6.6H19.7L20.1 5.5H22L22.2 6.6ZM20.5 4.3L21.2 2.5L21.6 4.3H20.5Z"
                      fill="#1434CB"
                    />
                  </svg>
                </div>
                ...
                >
                  <svg width="24" height="14" viewBox="0 0 24 14" fill="none">
                    ...
                    <path
                      d="M12 2.5C13.1 3.4 13.9 4.7 14.2 6.2H9.8C10.1 4.7 10.9 3.4 12 2.5Z"
                      fill="#FF5F00"
                    />
                    <path
                      d="M12 11.5C10.9 10.6 10.1 9.3 9.8 7.8H14.2C13.9 9.3 13.1 10.6 12 11.5Z"
                      fill="#FF5F00"
                    />
                  </svg>
                </div>
                ...
                >
                  <svg width="20" height="12" viewBox="0 0 20 12" fill="none">
                    ...
                    <text x="2.5" y="8" fill="white" fontSize="3" fontWeight="bold">
                      J
                    </text>
                    <text x="7.5" y="8" fill="white" fontSize="3" fontWeight="bold">
                      C
                    </text>
                    <text x="12.5" y="8" fill="white" fontSize="3" fontWeight="bold">
                      B
                    </text>
                  </svg>
                </div>
            ...
            >
              <p style={{ margin: '0 0 8px 0' }}>
                Notwithstanding the logo displayed above, when paying with a
                co-branded eftpos debit card, your payment may be processed
                through either card network.
              </p>
              <p style={{ margin: '0 0 16px 0' }}>
                By subscribing, you authorize Summarist to charge you according
